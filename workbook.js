...
===============================================================*/
const countOccurrences = myString => {
  //code here
};
/*===============================================================
...
===============================================================*/
const deleteDuplicates = myLinkedList => {
  //code here
};
/*===============================================================
3. Given a string, write an algorithm to 
count the number of words in the string that are palindromes. 
...
const countPalindromes = myString => {
  //code here
};
...
//
/* ===============================================================
 5. Given 2 linked lists, 
 where each node in each linked list represents a character in a string, 
 write a function compare() that compares the 2 strings, 
 i.e., it returns:
...
===============================================================*/
const findModeAndFrequency = myList => {
  //code here
};
